...
petik = '```'
fake = 'CREATOR BOT\©NandoBot'//GANTI NAMA KAMU BEP
ban =[]
...
dha.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
        ...
        case 'menu':
        case 'help':
        menu =`Hai Kak.....\n*${pushname}*\n\`\`\`Saya Nando-Botz,SENANG BISA BERTEMU DENGANMU HARI INI\`\`\`
...
❏ LINK YOUTUBE : https://YouTube.com/c/OMTOSLURR
...
©𝑪𝒓𝒆𝒂𝒕𝒐𝒓 ©Nando`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '\`\`\`MAU BELI SC INI HUBUNGIN Nando WA 6288226081545\`\`\`', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
       ...
       case 'store':
               ...
               listmsg(from, `${ucapanWaktu}`,   `Hai kak.....\n*${pushname}*\nJangan Lupa Subscribe Nando Yahh Ini Link Nya = https://YouTube.com/c/OMTOSLURR`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
*[Wait] Tunggu Sebentar..*`
				...
				case 'play':
              if (!q) return reply('Linknya?')
              buttons = [{buttonId: `${prefix}play2 ${q}`,buttonText:{displayText: `[🎥 Video]`},type:1},{buttonId:`${prefix}playy ${q}`,buttonText:{displayText:'[🎵 Musik/Mp3]'},type:1}]
              ...
              buttonsMessage = {footerText:'Jangan Lupa Donasi Ya Kak ☕', imageMessage: imageMsg,
              contentText:`Silahkan Pilih Media Yg Akan Di Download kak DAN Jangan download aja subscribe dulu channel  = https://Youtube.com/c/OMTOSLURR`,buttons,headerType:4}
              prep = await dha.prepareMessageFromContent(from,{buttonsMessage},{quoted: mek})
              dha.relayWAMessage(prep)
              break
          case 'lirik':
...
case 'getvn':
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             sendMess(_.jid, `*「 PESAN SIARAN Nando-Botz 
             AND SUBSCRIBE https://youtube.com/c/OMTOSOURR」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
